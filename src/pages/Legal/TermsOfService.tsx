...
const sections = [
  ...
  { title: '4. Developer Tools & Node Operations', body: 'The Compliance Sandbox and TypeScript SDK are provided "as-is" for institutional evaluation. Node operations (Validator, Archive, Facilitator) require a formal application and credentialing process. Submission of an application does not guarantee acceptance. Production access requires a separate credentialing agreement with WaveCollapse.' },
